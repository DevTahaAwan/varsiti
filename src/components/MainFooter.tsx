    ...
    <footer className="mt-10 rounded-2xl border border-border/70 bg-card/80 backdrop-blur-sm px-4 md:px-6 py-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
      <div className="space-y-0.5">
        <div className="flex items-center gap-2">
          <p className="text-sm font-semibold text-foreground">© Copyright Varsiti Inc.</p>
          <span className="px-2 py-0.5 text-[10px] font-bold tracking-wider rounded-md bg-primary/10 text-primary border border-primary/20">v1.4.0</span>
        </div>
